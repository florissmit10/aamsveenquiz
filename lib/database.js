...
var MapPhotoQuestion = require('./../models/mapPhotoQuestion.js');
	...
	return {
		config: function (conf) {
            ...
            db.once('open', function callback() {
				...
				MapPhotoQuestion.count(function(err,count){
...
function insert_questions(){
		var qs = fs.readFile(__dirname+'/../data/toerist.json',function(err, data){
			...
			for(var i =0;i<features.length;i++){
				...
				var newQ = new MapPhotoQuestion({type:o.attributes.FIELD1 , photo: photos ,geometry: o.geometry});
				newQ.save();
			}
